...
- Concurrent sessions: Allowed. Each family member should have their own admin account (created via seed script or admin CLI) for better audit trail accountability. Multiple devices/sessions per account are permitted.
