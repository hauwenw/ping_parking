...
When you need to check technical specifications, API documentation, or implementation details for the tech stack, you should use your knowledge and access to up-to-date information for:
